...
# DVE reload session
# Saved on Sun May 5 02:10:00 2024
# Designs open: 1
...
# MDI window settings
set Wave.1 Wave.1
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 557} {child_wave_right 1357} {child_wave_colname 225} {child_wave_colvalue 328} {child_wave_col1 0} {child_wave_col2 1}}
...
# MDI window settings
set Wave.2 Wave.2
gui_update_layout -id ${Wave.2} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 557} {child_wave_right 1357} {child_wave_colname 185} {child_wave_colvalue 368} {child_wave_col1 0} {child_wave_col2 1}}
...
gui_marker_move -id ${Wave.1} {C1} 6398
...
gui_list_select -id ${Wave.2} {cache_tb.iA.address0 }
...
gui_marker_move -id ${Wave.2} {C1} 6398
