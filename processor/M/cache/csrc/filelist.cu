...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _945551_archive_1.so
_945551_archive_1.so : archive.178/_945551_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -Bsymbolic $(LD_NORELAX_FLAG)  -o .//../simv.daidir//_945551_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_945551_archive_1.so $@


ARCHIVE_OBJS += _prev_archive_1.so
_prev_archive_1.so : archive.178/_prev_archive_1.a
	@$(AR) -s $<
...
CU_UDP_OBJS = \
objs/udps/H4YNa.o objs/udps/BYmPi.o objs/udps/pIp1i.o objs/udps/i5D5s.o objs/udps/abmDd.o  \
